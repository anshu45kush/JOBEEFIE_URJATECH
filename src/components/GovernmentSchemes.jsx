...
import { Building2, Calculator, Users, HelpCircle, FileCheck, Landmark } from 'lucide-react';
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center text-white">
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">
              Get up to ₹78,000 subsidy on residential solar installations under PM Surya Ghar Muft Bijli Yojana. We handle the paperwork for you.
            </p>
          </motion.div>
        </div>
      </div>
          ...
          >
            ...
            {activeTab === 'state' && (
              <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                <div className="mb-8">
                   <h3 className="text-2xl font-bold text-[#1a3a52] mb-2">Uttar Pradesh State Subsidies</h3>
                   <p className="text-gray-600">Additional benefits provided by UPNEDA (Uttar Pradesh New and Renewable Energy Development Agency).</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-700">UP Government often provides top-up subsidies (e.g., ₹15,000/kW up to 30k) in addition to central subsidy. *Subject to fund availability.</p>
                        
                        <h4 className="font-bold text-lg flex items-center gap-2 mt-6">
                            <FileCheck className="w-5 h-5 text-[#FF9500]" />
                            Net Metering
                        </h4>
                        <p className="text-gray-700">UPPCL provides net metering facility where you can export excess power to the grid and get credit in your bill.</p>
                    </div>
                    <div className="bg-blue-50 p-6 rounded-xl">
                        <h4 className="font-bold text-[#1a3a52] mb-4">Official Contacts</h4>
                        ...
                        <Button className="w-full mt-6 bg-[#1a3a52] text-white">Visit UPNEDA Website</Button>
                    </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'faq' && (
              <div className="max-w-3xl mx-auto">
                <h3 className="text-2xl font-bold text-[#1a3a52] mb-8 text-center">Frequently Asked Questions</h3>
                <div className="space-y-4">
